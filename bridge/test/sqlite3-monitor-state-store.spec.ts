...
describe("Sqlite3MonitorStateStore", () => {
    ...
    it("should overwrite if the network existed.", async () => {
        ...
        await stateStore.store("9c-main", { blockHash: otherBlockHash, txId: otherTxId, });
        expect(await stateStore.load("9c-main")).toEqual({ blockHash: otherBlockHash, txId: otherTxId, });
    });
