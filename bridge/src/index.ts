...
(async () => {
    ...
    const ethereumBurnEventObserver = new EthereumBurnEventObserver(ncgKmsTransfer, slackMessageSender, monitorStateStore, EXPLORER_ROOT_URL, ETHERSCAN_ROOT_URL, integration);
    ...
    const ncgTransferredEventObserver = new NCGTransferredEventObserver(ncgKmsTransfer, minter, slackMessageSender, monitorStateStore, exchangeHistoryStore, EXPLORER_ROOT_URL, ETHERSCAN_ROOT_URL, ncgExchangeFeeRatio, {
        maximum: MAXIMUM_NCG,
        minimum: MINIMUM_NCG,
